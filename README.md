...
Reason: On a near-future, you may want to free up some storage. Just look for this list for software you don't need anymore.  
Usage: `newapp [app-info]`  
Note: It's arbitrary, but I recommend the app-info format to be: `Name - Reason to install/utility - Size`.  
